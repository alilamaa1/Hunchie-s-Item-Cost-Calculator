...
export function createPreloadApi(ipcRenderer) {
  return Object.freeze({
    ...
    listBatches: () => ipcRenderer.invoke(IpcChannels.BATCH_LIST),
    createBatch: (input) => ipcRenderer.invoke(IpcChannels.BATCH_CREATE, input),
    updateBatch: (id, input) => ipcRenderer.invoke(IpcChannels.BATCH_UPDATE, id, input),
    getBatch: (id) => ipcRenderer.invoke(IpcChannels.BATCH_DETAIL, id),
    deleteBatch: (id) => ipcRenderer.invoke(IpcChannels.BATCH_DELETE, id),
    calculateBatchDraft: (input) => ipcRenderer.invoke(IpcChannels.BATCH_DRAFT_CALCULATE, input),
