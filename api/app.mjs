...
const handlers = Object.freeze({
  ...
  listBatches: () => services.listBatches(context()),
  createBatch: (input) => services.createBatch(input, context()),
  updateBatch: (id, input) => services.updateBatch(id, input, context()),
  getBatch: (id) => services.getBatchById(id, context()),
  deleteBatch: (id) => services.deleteBatch(id, context()),
  calculateBatchDraft: (input) => services.calculateBatchDraft(input, context()),
